...
const SNAPSHOT_VSS_PATHS: &[&str] = &[
    vss::VSS_VEHICLE_BODY_LIGHTS_DIRECTIONINDICATOR_RIGHT_ISSIGNALING,
    vss::VSS_VEHICLE_BODY_LIGHTS_DIRECTIONINDICATOR_LEFT_ISSIGNALING,
    vss::VSS_VEHICLE_BODY_LIGHTS_BRAKE_ISACTIVE,
    ...
    vss::VSS_VEHICLE_DRIVER_IDENTIFIER_SUBJECT,
